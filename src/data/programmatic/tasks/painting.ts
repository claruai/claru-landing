...
const data: TaskPageData = {
  slug: "painting",
  metaTitle: "Painting Training Data for Robotics | Claru",
  metaDescription:
  ...
  primaryKeyword: "robotic painting training data",
  secondaryKeywords: [
    "painting task dataset",
    "robot spray painting demonstrations",
    "coating automation training data",
    "spray pattern control dataset",
    "surface coating robot data",
    "paint thickness optimization data"
],
  canonicalPath: "/training-data/painting",
  h1: "Painting Task Training Data",
  heroSubtitle:
  ...
  breadcrumbs: [
    ...
    { label: "Painting", href: "/training-data/painting" },
  ],
  sections: [
    {
      type: "prose",
      heading: "What Is Robotic Painting and Why Does Data Matter?",
      paragraphs: [
    ...
    {
      type: "stats",
      heading: "Painting Data by the Numbers",
      stats: [
        { value: "85-95%", label: "Multimodal policy success rate on painting" },
    ...
    {
      type: "prose",
      heading: "State of the Art in Learned Painting",
      paragraphs: [
    ...
    {
      type: "prose",
      heading: "Collection Methodology for Painting Data",
      paragraphs: [
    ...
    {
      type: "prose",
      heading: "How Claru Supports Painting Data Needs",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How many demonstrations are needed for painting?",
      answer:
    ...
    {
      question: "Is force/torque data essential for painting demonstrations?",
      answer:
    ...
    {
      question: "Can simulation replace real painting demonstrations?",
      answer:
  ...
  ctaHeading: "Get a Custom Quote for Painting Task Data",
  ctaDescription:
    "Tell us about your painting requirements and we will design a data collection plan matched to your specific application and deployment constraints.",
  ...
  dataRequirements: {
    modality: "RGB + film thickness sensing + spray parameters + robot pose + booth conditions",
    volumeRange: "500-5,000 painting demonstrations per surface type",
    temporalResolution: "30 Hz video, continuous spray parameter logging, per-pass thickness measurements",
    keyAnnotations: [
      "Spray gun pose trajectory (position, orientation, distance to surface)",
      "Spray parameters (pressure, flow rate, fan width, atomization)",
      "Film thickness measurements (per-pass and cumulative)",
      "Coverage percentage and uniformity metrics",
      "Surface geometry and preparation condition",
      "Paint type, viscosity, and environmental conditions (temperature, humidity)"
],
  },
  relevantModels: [
    "Trajectory optimization for coating",
    "Coverage path planning models",
    "Spray simulation (CFD-based)",
    "Digital twin painting systems",
    "Adaptive spray control",
    "Film thickness prediction networks"
],
  environmentTypes: [
