...
const data: TaskPageData = {
  slug: "drawer-manipulation",
  metaTitle: "Drawer Manipulation Training Data for Robotics | Claru",
  metaDescription:
  ...
  primaryKeyword: "drawer manipulation training data",
  secondaryKeywords: [
    "drawer manipulation dataset",
    "articulated object interaction data",
    "robot drawer opening demonstrations",
    "handle grasping training data",
    "sliding mechanism automation data",
    "cabinet manipulation robot dataset"
],
  canonicalPath: "/training-data/drawer-manipulation",
  h1: "Drawer Manipulation Task Training Data",
  heroSubtitle:
    "Drawer manipulation datasets for articulated object interaction — opening, closing, and content retrieval from drawers and sliding mechanisms with joint state estimation and force-controlled pulling annotations.",
  breadcrumbs: [
    { label: "Home", href: "/" },
    { label: "Training Data", href: "/training-data" },
    { label: "Drawer Manipulation", href: "/training-data/drawer-manipulation" },
  ],
  sections: [
    {
      type: "prose",
      heading: "What Is Robotic Drawer Manipulation and Why Does Data Matter?",
      paragraphs: [
    ...
    },
    {
      ...
      description:
        "Different learning architectures for drawer manipulation have distinct data requirements. Choose based on your deployment constraints and available sensing.",
      columns: [
        "Approach",
        "Data Volume",
        "Key Modalities",
  ...
  faqs: [
    {
      question: "How many demonstrations are needed for drawer manipulation?",
      answer:
    ...
    {
      question: "Is force/torque data essential for drawer manipulation demonstrations?",
      answer:
  ...
  ctaHeading: "Get a Custom Quote for Drawer Manipulation Task Data",
  ctaDescription:
    "Tell us about your drawer manipulation requirements and we will design a data collection plan matched to your specific application and deployment constraints.",
  ...
  dataRequirements: {
    modality: "RGB-D + proprioception + joint state estimation + handle pose",
    volumeRange: "500-2,000 demonstrations per drawer type",
    temporalResolution: "30 Hz video, continuous joint angle tracking, per-episode annotations",
    keyAnnotations: [
      "Handle grasp pose and grasp type classification",
      "Drawer joint angle trajectory during open/close",
      "Pull/push force profile along drawer axis",
      "Articulation model parameters (prismatic joint limits, friction)",
      "Content interaction annotations (reaching into, retrieving from drawer)",
      "Success/failure with failure mode (handle miss, jam, overextension)"
],
  },
  relevantModels: [
    "FlowBot3D",
