...
const data: TaskPageData = {
  slug: "button-pressing",
  metaTitle: "Button Pressing Training Data for Robotics | Claru",
  metaDescription:
  ...
  primaryKeyword: "button pressing training data",
  secondaryKeywords: [
    "button pressing dataset",
    "robot switch interaction data",
    "push button training data",
    "tactile pressing automation data",
    "control panel manipulation dataset",
    "interface activation robot data"
],
  canonicalPath: "/training-data/button-pressing",
  h1: "Button Pressing Task Training Data",
  heroSubtitle:
  ...
  breadcrumbs: [
    ...
    { label: "Button Pressing", href: "/training-data/button-pressing" },
  ],
  sections: [
    {
      type: "prose",
      heading: "What Is Robotic Button Pressing and Why Does Data Matter?",
      paragraphs: [
    ...
    {
      type: "stats",
      heading: "Button Pressing Data by the Numbers",
      stats: [
        { value: "85-95%", label: "Multimodal policy success rate on button pressing" },
    ...
    {
      type: "prose",
      heading: "State of the Art in Learned Button Pressing",
      paragraphs: [
    ...
    {
      type: "prose",
      heading: "Collection Methodology for Button Pressing Data",
      paragraphs: [
    ...
    {
      type: "prose",
      heading: "How Claru Supports Button Pressing Data Needs",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How many demonstrations are needed for button pressing?",
      answer:
    ...
    {
      question: "Is force/torque data essential for button pressing demonstrations?",
      answer:
    ...
    {
      question: "Can simulation replace real button pressing demonstrations?",
      answer:
  ...
  ctaHeading: "Get a Custom Quote for Button Pressing Task Data",
  ctaDescription:
  ...
  dataRequirements: {
    modality: "RGB + force/torque + tactile sensing + button state",
    volumeRange: "200-1,000 demonstrations per button type",
    temporalResolution: "30 Hz video, 500 Hz force/torque, per-press activation annotations",
    keyAnnotations: [
      "Button location and type classification",
      "Press force profile with activation threshold detection",
      "Pre-press approach trajectory and alignment",
      "Button state change confirmation (visual or tactile)",
      "Press duration and release timing",
      "Success/failure with failure mode (miss, insufficient force, wrong button)"
],
  },
  relevantModels: [
    "Diffusion Policy",
