...
const page: BenchmarkPageData = {
  ...
  metaTitle:
    "LIBERO Benchmark: 130 Tasks, Real-World Training Data & Sim-to-Real Guide | Claru",
  metaDescription:
    "Complete guide to the LIBERO lifelong robot learning benchmark — 130 manipulation tasks, 5 evaluation suites, and what real-world data you need to transfer LIBERO policies to physical robots.",
