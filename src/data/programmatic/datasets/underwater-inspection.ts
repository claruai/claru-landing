...
const data: DatasetPageData = {
  ...
  metaTitle: "Underwater Inspection Dataset for Robotics AI | Claru",
  metaDescription: "Underwater ROV and diver-captured video of subsea infrastructure. 30K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "underwater inspection dataset",
  secondaryKeywords: ["underwater video dataset","ROV inspection data","subsea defect detection","marine infrastructure data","underwater object detection"],
  canonicalPath: "/datasets/underwater-inspection",
  h1: "Underwater Inspection Dataset",
  heroSubtitle: "Underwater video from ROVs and divers inspecting subsea infrastructure — pipelines, offshore platforms, ship hulls, port structures — with corrosion, biofouling, and structural damage annotations.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Underwater Inspection Dataset", href: "/datasets/underwater-inspection" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Subsea Inspection domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world rgb data remains a fundamental bottleneck for reliable deployment.",
      ...
      "For teams building Subsea Inspection systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "30K+", label: "Clips / scans" },{ value: "200+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
  ...
  datasetProfile: { modalities: ["rgb" as any], totalClips: "30K+", totalHours: "200+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  ...
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Subsea Inspection applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Subsea Inspection environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Subsea Inspection domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
