...
const data: DatasetPageData = {
  slug: "stereo-manipulation",
  metaTitle: "Stereo Manipulation Dataset for Robotics AI | Claru",
  metaDescription: "Calibrated stereo camera recordings of tabletop and industrial manipulation. 60K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "stereo manipulation dataset",
  secondaryKeywords: ["stereo vision dataset","binocular manipulation data","depth estimation training","stereo robot vision","calibrated stereo pairs"],
  canonicalPath: "/datasets/stereo-manipulation",
  h1: "Stereo Manipulation Dataset",
  heroSubtitle: "Calibrated stereo camera recordings of manipulation tasks — pick-and-place, assembly, tool use — providing dense depth estimation ground truth for training depth-aware robot policies.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Stereo Manipulation Dataset", href: "/datasets/stereo-manipulation" }],
  sections: [
    ...
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "60K+", label: "Clips / scans" },{ value: "380+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
  ...
  faqs: [
    { question: "What sensor specifications are used?", answer: "Collection uses calibrated stereo sensors at full resolution with synchronized metadata. Specific sensor models and configurations vary by collection site and are documented in the dataset metadata. Custom sensor configurations can be accommodated for new collection campaigns." },
  ...
  relatedGlossaryTerms: ["stereo","manipulation-trajectory","activity-annotation","temporal-annotation"],
  relatedGuidePages: [],
  relatedSolutionSlugs: [],
  datasetProfile: { modalities: ["stereo" as any], totalClips: "60K+", totalHours: "380+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  comparisonWithPublic: [
    { name: "Academic Baseline A", clips: "~10K", hours: "~50", modalities: "stereo", environments: "1-3 sites", annotations: "Basic labels" },
    { name: "Academic Baseline B", clips: "~25K", hours: "~100", modalities: "stereo", environments: "3-5 sites", annotations: "Actions, objects" }
  ],
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Depth-Aware Manipulation applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Depth-Aware Manipulation environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Depth-Aware Manipulation domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
