...
const data: DatasetPageData = {
  slug: "event-camera-manipulation",
  metaTitle: "Event Camera Manipulation Dataset for Robotics AI | Claru",
  metaDescription: "Event camera recordings of high-speed manipulation tasks. 40K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "event camera manipulation dataset",
  secondaryKeywords: ["event-driven vision data","dynamic vision sensor dataset","neuromorphic manipulation data","DVS robot training data","high-speed grasping data"],
  canonicalPath: "/datasets/event-camera-manipulation",
  h1: "Event Camera Manipulation Dataset",
  heroSubtitle: "High-temporal-resolution event camera recordings of manipulation tasks — fast grasping, dynamic catching, tool use — for training reactive robot policies that require microsecond-level visual feedback.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Event Camera Manipulation Dataset", href: "/datasets/event-camera-manipulation" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The High-Speed Manipulation domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world event-camera data remains a fundamental bottleneck for reliable deployment.",
      "This dataset addresses the gap by providing purpose-collected event-camera recordings from real-world environments with dense, human-verified annotations. Every clip captures genuine interactions and conditions — not staged demonstrations or simplified lab setups. The environmental diversity across collection sites ensures trained models generalize to the range of conditions they will encounter in production.",
      "For teams building High-Speed Manipulation systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "40K+", label: "Clips / scans" },{ value: "250+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
    { type: "prose", heading: "Collection Methodology", paragraphs: [
      "Claru collectors deploy calibrated event-camera sensor rigs in real-world environments following standardized collection protocols. Each session captures continuous recordings across varied conditions — different times of day, weather states, and activity levels — to ensure the dataset covers the full operational distribution of the target application.",
  ...
  faqs: [
    { question: "What sensor specifications are used?", answer: "Collection uses calibrated event-camera sensors at full resolution with synchronized metadata. Specific sensor models and configurations vary by collection site and are documented in the dataset metadata. Custom sensor configurations can be accommodated for new collection campaigns." },
  ...
  relatedGlossaryTerms: ["event-camera","manipulation-trajectory","activity-annotation","temporal-annotation"],
  relatedGuidePages: [],
  relatedSolutionSlugs: [],
  datasetProfile: { modalities: ["event-camera" as any], totalClips: "40K+", totalHours: "250+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  comparisonWithPublic: [
    { name: "Academic Baseline A", clips: "~10K", hours: "~50", modalities: "event-camera", environments: "1-3 sites", annotations: "Basic labels" },
    { name: "Academic Baseline B", clips: "~25K", hours: "~100", modalities: "event-camera", environments: "3-5 sites", annotations: "Actions, objects" }
  ],
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for High-Speed Manipulation applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in High-Speed Manipulation environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in High-Speed Manipulation domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
