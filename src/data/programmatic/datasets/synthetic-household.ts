...
const data: DatasetPageData = {
  slug: "synthetic-household",
  metaTitle: "Synthetic Household Dataset for Robotics AI | Claru",
  metaDescription: "Photorealistic synthetic renders of household environments and activities. 200K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "synthetic household dataset",
  secondaryKeywords: ["synthetic indoor dataset","rendered household data","virtual home training","simulated domestic data","procedural household generation"],
  canonicalPath: "/datasets/synthetic-household",
  h1: "Synthetic Household Dataset",
  heroSubtitle: "Photorealistic synthetic renders of household environments — living rooms, bedrooms, bathrooms, garages — with perfect ground truth annotations for pre-training household robot perception before real-world fine-tuning.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Synthetic Household Dataset", href: "/datasets/synthetic-household" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Sim-to-Real Transfer domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world rgb data remains a fundamental bottleneck for reliable deployment.",
      ...
      "For teams building Sim-to-Real Transfer systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "200K+", label: "Clips / scans" },{ value: "N/A (rendered)", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
  ...
  datasetProfile: { modalities: ["rgb" as any], totalClips: "200K+", totalHours: "N/A (rendered)", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  ...
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Sim-to-Real Transfer applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Sim-to-Real Transfer environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Sim-to-Real Transfer domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
