...
const data: DatasetPageData = {
  ...
  metaTitle: "Aerial Inspection Dataset for Robotics AI | Claru",
  metaDescription: "Drone-captured aerial inspection video of infrastructure and facilities. 45K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "aerial inspection dataset",
  secondaryKeywords: ["drone inspection dataset","aerial defect detection","UAV inspection data","infrastructure monitoring","power line inspection"],
  canonicalPath: "/datasets/aerial-inspection",
  h1: "Aerial Inspection Dataset",
  heroSubtitle: "Drone-captured video of infrastructure inspection — bridges, powerlines, solar farms, building facades, cell towers — with defect annotations and structural element labels for training automated aerial inspection AI.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Aerial Inspection Dataset", href: "/datasets/aerial-inspection" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Infrastructure Inspection domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world rgb data remains a fundamental bottleneck for reliable deployment.",
      ...
      "For teams building Infrastructure Inspection systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "45K+", label: "Clips / scans" },{ value: "300+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
  ...
  datasetProfile: { modalities: ["rgb" as any], totalClips: "45K+", totalHours: "300+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  ...
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Infrastructure Inspection applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Infrastructure Inspection environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Infrastructure Inspection domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
