...
const data: DatasetPageData = {
  slug: "point-cloud-outdoor",
  metaTitle: "Outdoor Point Cloud Dataset for Robotics AI | Claru",
  metaDescription: "Dense 3D point clouds of outdoor environments from LiDAR and photogrammetry. 35K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "outdoor point cloud dataset",
  secondaryKeywords: ["outdoor 3D reconstruction","terrain point cloud","environmental mapping data","outdoor scene understanding","ground surface classification"],
  canonicalPath: "/datasets/point-cloud-outdoor",
  h1: "Outdoor Point Cloud Dataset",
  heroSubtitle: "Dense 3D point clouds of outdoor environments — parks, construction sites, agricultural fields, forests — from LiDAR scanning and photogrammetry for training outdoor navigation and terrain analysis models.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Outdoor Point Cloud Dataset", href: "/datasets/point-cloud-outdoor" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Outdoor 3D Perception domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world point-cloud data remains a fundamental bottleneck for reliable deployment.",
      "This dataset addresses the gap by providing purpose-collected point-cloud recordings from real-world environments with dense, human-verified annotations. Every clip captures genuine interactions and conditions — not staged demonstrations or simplified lab setups. The environmental diversity across collection sites ensures trained models generalize to the range of conditions they will encounter in production.",
      "For teams building Outdoor 3D Perception systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "35K+", label: "Clips / scans" },{ value: "280+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
    { type: "prose", heading: "Collection Methodology", paragraphs: [
      "Claru collectors deploy calibrated point-cloud sensor rigs in real-world environments following standardized collection protocols. Each session captures continuous recordings across varied conditions — different times of day, weather states, and activity levels — to ensure the dataset covers the full operational distribution of the target application.",
  ...
  faqs: [
    { question: "What sensor specifications are used?", answer: "Collection uses calibrated point-cloud sensors at full resolution with synchronized metadata. Specific sensor models and configurations vary by collection site and are documented in the dataset metadata. Custom sensor configurations can be accommodated for new collection campaigns." },
  ...
  relatedGlossaryTerms: ["point-cloud","manipulation-trajectory","activity-annotation","temporal-annotation"],
  relatedGuidePages: [],
  relatedSolutionSlugs: [],
  datasetProfile: { modalities: ["point-cloud" as any], totalClips: "35K+", totalHours: "280+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  comparisonWithPublic: [
    { name: "Academic Baseline A", clips: "~10K", hours: "~50", modalities: "point-cloud", environments: "1-3 sites", annotations: "Basic labels" },
    { name: "Academic Baseline B", clips: "~25K", hours: "~100", modalities: "point-cloud", environments: "3-5 sites", annotations: "Actions, objects" }
  ],
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Outdoor 3D Perception applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Outdoor 3D Perception environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Outdoor 3D Perception domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
