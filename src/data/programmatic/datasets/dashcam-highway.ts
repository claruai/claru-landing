...
const data: DatasetPageData = {
  slug: "dashcam-highway",
  metaTitle: "Highway Dashcam Dataset for Robotics AI | Claru",
  metaDescription: "Continuous dashcam recordings from highway and freeway driving. 110K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "highway dashcam dataset",
  secondaryKeywords: ["highway driving dataset","freeway video data","lane change detection","highway traffic data","autonomous highway data"],
  canonicalPath: "/datasets/dashcam-highway",
  h1: "Highway Dashcam Dataset",
  heroSubtitle: "Continuous dashcam video from highway and freeway driving across diverse road conditions — multi-lane traffic, merging, construction zones, weather events — with lane-level annotations for training highway driving assistance and autonomous highway systems.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Highway Dashcam Dataset", href: "/datasets/dashcam-highway" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Highway Driving AI domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world rgb data remains a fundamental bottleneck for reliable deployment.",
      ...
      "For teams building Highway Driving AI systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "110K+", label: "Clips / scans" },{ value: "750+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
  ...
  datasetProfile: { modalities: ["rgb" as any], totalClips: "110K+", totalHours: "750+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  ...
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Highway Driving AI applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Highway Driving AI environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Highway Driving AI domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
