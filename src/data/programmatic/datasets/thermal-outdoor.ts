...
const data: DatasetPageData = {
  slug: "thermal-outdoor",
  metaTitle: "Thermal Outdoor Dataset for Robotics AI | Claru",
  metaDescription: "Thermal infrared recordings of outdoor environments and activities. 55K+ clips for training embodied AI, robotic perception, and automation systems.",
  primaryKeyword: "thermal outdoor dataset",
  secondaryKeywords: ["thermal imaging dataset","LWIR outdoor data","night vision training data","thermal pedestrian detection","infrared surveillance data"],
  canonicalPath: "/datasets/thermal-outdoor",
  h1: "Thermal Outdoor Dataset",
  heroSubtitle: "Thermal infrared video of outdoor environments — pedestrians, vehicles, wildlife, terrain — captured across day/night and seasonal conditions for training robust perception systems that operate beyond the visible spectrum.",
  breadcrumbs: [{ label: "Home", href: "/" },{ label: "Datasets", href: "/datasets" },{ label: "Thermal Outdoor Dataset", href: "/datasets/thermal-outdoor" }],
  sections: [
    { type: "prose", heading: "Why This Data Matters for Robotics", paragraphs: [
      "The Outdoor Thermal Perception domain represents a critical frontier for robotic perception and autonomous systems. Real-world deployment demands training data captured in authentic environments with the specific sensor modalities, environmental conditions, and task complexity that target applications encounter. Simulation and synthetic data provide useful pre-training signals, but the domain gap between synthetic and real-world thermal data remains a fundamental bottleneck for reliable deployment.",
      "This dataset addresses the gap by providing purpose-collected thermal recordings from real-world environments with dense, human-verified annotations. Every clip captures genuine interactions and conditions — not staged demonstrations or simplified lab setups. The environmental diversity across collection sites ensures trained models generalize to the range of conditions they will encounter in production.",
      "For teams building Outdoor Thermal Perception systems, the annotation quality and density determines the ceiling of model performance. Claru's multi-layer annotation pipeline applies task-specific labels with human verification at every stage, producing training data where annotation accuracy matches the precision requirements of the downstream application."
    ]},
    { type: "stats", heading: "Dataset at a Glance", stats: [{ value: "55K+", label: "Clips / scans" },{ value: "350+", label: "Hours captured" },{ value: "15+", label: "Collection sites" },{ value: "8+", label: "Annotation layers" }]},
    { type: "prose", heading: "Collection Methodology", paragraphs: [
      "Claru collectors deploy calibrated thermal sensor rigs in real-world environments following standardized collection protocols. Each session captures continuous recordings across varied conditions — different times of day, weather states, and activity levels — to ensure the dataset covers the full operational distribution of the target application.",
  ...
  faqs: [
    { question: "What sensor specifications are used?", answer: "Collection uses calibrated thermal sensors at full resolution with synchronized metadata. Specific sensor models and configurations vary by collection site and are documented in the dataset metadata. Custom sensor configurations can be accommodated for new collection campaigns." },
  ...
  relatedGlossaryTerms: ["thermal","manipulation-trajectory","activity-annotation","temporal-annotation"],
  relatedGuidePages: [],
  relatedSolutionSlugs: [],
  datasetProfile: { modalities: ["thermal" as any], totalClips: "55K+", totalHours: "350+", annotationLayers: ["Spatial annotations","Temporal segments","Semantic labels","Quality indicators","Object tracking","Scene classification"], formats: ["RLDS","HDF5","WebDataset","MP4+JSON"], resolution: "1920x1080", fps: "30 fps" },
  comparisonWithPublic: [
    { name: "Academic Baseline A", clips: "~10K", hours: "~50", modalities: "thermal", environments: "1-3 sites", annotations: "Basic labels" },
    { name: "Academic Baseline B", clips: "~25K", hours: "~100", modalities: "thermal", environments: "3-5 sites", annotations: "Actions, objects" }
  ],
  useCases: [
    { modelType: "Perception Models", description: "Object detection, segmentation, and scene understanding for Outdoor Thermal Perception applications.", exampleModels: ["DINO","SAM","Grounding DINO"] },
    { modelType: "Policy Learning", description: "Visual observation-based policy training for robotic systems operating in Outdoor Thermal Perception environments.", exampleModels: ["RT-2","OpenVLA","ACT"] },
    { modelType: "World Models", description: "Physical dynamics prediction and scene forecasting for planning in Outdoor Thermal Perception domains.", exampleModels: ["UniSim","Genie 2","DIAMOND"] }
  ],
  keyPapers: [
