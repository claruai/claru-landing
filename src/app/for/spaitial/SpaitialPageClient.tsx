...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Diverse Environment Capture",
    description:
      "We've captured thousands of hours of video across real-world 3D environments — workshops, kitchens, retail spaces, factories, offices, outdoor settings — in 14 countries. Structured with spatial metadata and environment context.",
  },
  {
    number: "02",
    title: "Annotation for Spatial Understanding",
    description:
      "Our annotation teams can label spatial relationships, object placement, scene geometry, and environmental properties in video — at the precision spatial foundation models need. We co-develop the labeling schema with your research team.",
  },
  {
    number: "03",
    title: "Custom Capture Campaigns",
    description:
      "If your models need specific environment types, viewing angles, or spatial scenarios that don't exist in your current training data, we can design and run targeted capture campaigns.",
  },
];
...
interface SpaitialPageClientProps {
...
export default function SpaitialPageClient({
  datasetSection,
  videoSection,
}: SpaitialPageClientProps) {
  return (
