...
const COMPANY_SLUG = "getreal";
const COMPANY_NAME = "GetReal Security";
const RECIPIENT_NAME = "Matt";
    ...
    <section className="relative px-6 pb-16 pt-28 md:px-8 md:pb-24 md:pt-36 lg:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          ...
          <span style={{ color: accent }}>Data & Annotation</span>
        </motion.h1>
        ...
        >
          ...
          <p>
            Detecting AI-generated content across images, audio, and video
            requires continuous streams of labeled real vs. synthetic data
            &mdash; every new generative model creates new artifacts your
            detectors need to learn. We think we could help.
          </p>
        </motion.div>
...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Real vs. Synthetic Labeling",
    description:
      "Our annotation teams can classify content across the authenticity spectrum \u2014 labeling real, manipulated, and AI-generated media across images, audio, and video with structured taxonomies and multi-reviewer consensus.",
  },
  {
    number: "02",
    title: "Multi-Modal Data Collection",
    description:
      "If your detection models need new examples of synthetic content from emerging generative techniques, we can source and organize diverse media samples across modalities \u2014 video, audio, images \u2014 with structured metadata.",
  },
  {
    number: "03",
    title: "Continuous Labeling Pipeline",
    description:
      "As new generative models emerge, your detectors need to keep pace. We can run an ongoing annotation pipeline that delivers fresh labeled data as the synthetic landscape evolves \u2014 without you rebuilding the operation each time.",
  },
];
      ...
      <div className="mx-auto max-w-[900px]">
        ...
        <div className="mt-14">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <CaseStudyCard slug="red-teaming-moderation" />
          </div>
        </div>
      </div>
    </section>
...
interface GetrealPageClientProps {
...
export default function GetrealPageClient({
  datasetSection,
}: GetrealPageClientProps) {
  return (
