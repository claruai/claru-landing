...
const COMPANY_SLUG = "cerrion";
const COMPANY_NAME = "Cerrion";
const RECIPIENT_NAME = "Karim";
  ...
  return (
    <section className="relative px-6 pb-16 pt-28 md:px-8 md:pb-24 md:pt-36 lg:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          Video Annotation{" "}
          <span style={{ color: accent }}>for Manufacturing AI</span>
        </motion.h1>
        ...
        >
          ...
          <p>
            Scaling video AI across manufacturing environments means the
            annotation workload grows with every new customer deployment. We
            think we could help take that off your plate.
          </p>
        </motion.div>
...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Manufacturing Video Annotation",
    description:
      "Our annotation teams can label industrial footage — semantic segmentation, deviation detection, process classification, safety events — at the quality your production-line models need. We co-develop the annotation schema with your team.",
  },
  {
    number: "02",
    title: "Scaling Across Factories",
    description:
      "Each new manufacturing customer means new processes, new equipment, new edge cases. We can run annotation pipelines that scale with your deployment — new factory environments get labeled consistently using your validated protocols.",
  },
  {
    number: "03",
    title: "Data Preparation & QA",
    description:
      "From raw CCTV footage to training-ready datasets — we handle the full pipeline: video preprocessing, structured labeling, multi-reviewer QA, and delivery in whatever format your training infrastructure needs.",
  },
];
...
interface CerrionPageClientProps {
...
export default function CerrionPageClient({
  datasetSection,
  videoSection,
}: CerrionPageClientProps) {
  return (
