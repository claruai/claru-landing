...
const COMPANY_SLUG = "rime";
const COMPANY_NAME = "Rime";
const RECIPIENT_NAME = "Lily";
      ...
      <div className="mx-auto max-w-[900px]">
        ...
        >
          <p>
            ...
            ($185M raised, YC/Khosla-backed), then spun it out as a standalone
            service for companies building with AI.
          </p>
          <p>
          ...
          <p>
            We think we could help with the multilingual annotation challenge
            you&apos;re scaling. Here&apos;s how we&apos;d approach it based
            on our understanding of what you need.
          </p>
        </motion.div>
...
// ---------------------------------------------------------------------------
// Section: How We'd Approach It
// ---------------------------------------------------------------------------

const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Managed Annotation Workforce",
    description:
      "We deploy native-speaker annotators across the languages you need — sourced, vetted, and managed by us. You define the annotation requirements, we handle recruiting, onboarding, QA, and day-to-day management so you don't have to build that operation internally.",
  },
  {
    number: "02",
    title: "Custom Data Collection",
    description:
      "If you need new speech or language data that doesn't exist yet, we can design and run collection campaigns using our global contributor network. We've done this across video, audio, and text — structured around your model's specific training requirements.",
  },
  {
    number: "03",
    title: "Annotation Protocol Development",
    description:
      "We work with your research team to develop the annotation guidelines, QA rubrics, and edge case frameworks — then execute against them at scale. The protocol stays yours; we bring the operational muscle to run it consistently across languages and annotators.",
  },
];
...
// ---------------------------------------------------------------------------
// Section: Who We Are / Work We've Done
// ---------------------------------------------------------------------------
...
export default function RimePageClient({
  datasetSection,
}: RimePageClientProps) {
  return (
    ...
    >
      <ExpiryGate createdAt={PAGE_CREATED}>
        ...
        {/* Hero — who we are, why we're reaching out */}
