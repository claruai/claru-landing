...
const COMPANY_SLUG = "coram-ai";
const COMPANY_NAME = "Coram AI";
const RECIPIENT_NAME = "Ashesh";
  ...
  return (
    <section className="relative px-6 pb-16 pt-28 md:px-8 md:pb-24 md:pt-36 lg:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          Video Security Data{" "}
          <span style={{ color: accent }}>&amp; Annotation</span>
        </motion.h1>
        ...
        >
          ...
          <p>
            Building AI that detects safety events in video is fundamentally a
            data problem &mdash; you need diverse, labeled examples of the
            behaviors your models need to recognize. We think we could help.
          </p>
        </motion.div>
...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Safety Event Data",
    description:
      "We can source and capture diverse video of safety-relevant scenarios \u2014 workplace incidents, behavioral patterns, environmental hazards \u2014 across varied settings, lighting, and demographics.",
  },
  {
    number: "02",
    title: "Video Classification & Labeling",
    description:
      "Our annotation teams can label behavioral events, object detection, and scene classification at the granularity your threat detection models need. We co-develop the taxonomy with your team and run it with structured QA.",
  },
  {
    number: "03",
    title: "Continuous Annotation Pipeline",
    description:
      "As you onboard new customers with new camera environments, the edge cases multiply. We can run an ongoing labeling pipeline that scales with your deployment \u2014 new scenarios, new environments, same quality bar.",
  },
];
      ...
      <div className="mx-auto max-w-[900px]">
        ...
        <div className="mt-14">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <CaseStudyCard slug="generative-ai-safety" />
          </div>
        </div>
      </div>
    </section>
...
interface CoramAiPageClientProps {
...
export default function CoramAiPageClient({
  datasetSection,
  videoSection,
}: CoramAiPageClientProps) {
  return (
