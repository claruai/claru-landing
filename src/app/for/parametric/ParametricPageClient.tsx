...
const COMPANY_SLUG = "parametric";
const COMPANY_NAME = "Parametric";
const RECIPIENT_NAME = "Cody";
  ...
  return (
    <section className="relative px-6 pb-16 pt-28 md:px-8 md:pb-24 md:pt-36 lg:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          Task Capture Data{" "}
          <span style={{ color: accent }}>for Robotics</span>
        </motion.h1>
        ...
        >
          ...
          <p>
            Teaching robots how tasks should be done in each new environment is a
            data capture problem. We&apos;ve built our whole operation around
            capturing task-specific execution in real workplaces &mdash; and we
            think we could help as you expand into new verticals.
          </p>
        </motion.div>
...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "On-Site Task Capture",
    description:
      "We deploy trained operators into real businesses with body-mounted cameras and structured protocols to capture how specific tasks are actually performed. We've done this across kitchens, textile shops, assembly lines, and more — in 14 countries.",
  },
  {
    number: "02",
    title: "Diverse Environment Coverage",
    description:
      "Each new customer has their own \"gold standard\" for how tasks should be done. We can capture that across multiple locations simultaneously — different businesses, different workflows, different physical setups — giving your models the diversity they need.",
  },
  {
    number: "03",
    title: "Annotation for Manipulation",
    description:
      "Our annotation teams can label the captured video with task segmentation, action boundaries, grasp types, and success/failure markers at the granularity your RL pipeline needs.",
  },
];
...
interface ParametricPageClientProps {
...
export default function ParametricPageClient({
  datasetSection,
  videoSection,
}: ParametricPageClientProps) {
  return (
