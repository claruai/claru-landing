...
const COMPANY_SLUG = "sereact";
const COMPANY_NAME = "Sereact";
const RECIPIENT_NAME = "Ralf";
  ...
  return (
    <section className="relative px-6 pb-16 pt-28 md:px-8 md:pb-24 md:pt-36 lg:px-12">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          Real-World Data{" "}
          <span style={{ color: accent }}>for Warehouse Robotics</span>
        </motion.h1>
        ...
        >
          ...
          <p>
            Training robotics foundation models on real-world data is a
            challenge we know well. Here&apos;s how we could help.
          </p>
        </motion.div>
...
const WAYS_WE_HELP = [
  {
    number: "01",
    title: "Real-World Manipulation Data",
    description:
      "We've captured thousands of hours of egocentric video across real workplace environments — assembly lines, warehouses, textile shops, kitchens — with structured action labels and metadata. If your models need diverse real-world manipulation scenarios beyond what your current deployments generate, we can source it.",
  },
  {
    number: "02",
    title: "Annotation & QA for Robotics",
    description:
      "Our annotation teams can label manipulation tasks, object interactions, grasp types, failure modes, and recovery behaviors at the granularity your models need. We co-develop the labeling schema with your team and run it with structured QA — multi-reviewer consensus and daily calibration.",
  },
  {
    number: "03",
    title: "Scaling Data Ops as You Deploy",
    description:
      "As you expand to new warehouse environments and new picking scenarios, the data needs grow with each deployment. We can run an ongoing annotation pipeline that scales alongside your rollout — new environments, new edge cases, continuous quality feedback — without you rebuilding the operation each time.",
  },
];
...
interface SereactPageClientProps {
...
export default function SereactPageClient({
  datasetSection,
  videoSection,
}: SereactPageClientProps) {
  return (
