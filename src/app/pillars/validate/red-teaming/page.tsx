            ...
            <div className="grid md:grid-cols-1 gap-6 max-w-xl">
              <CaseStudyCallout
                ...
                caseStudy={{
                  ...
                  headlineStat: "205K",
                  headlineStatLabel: "Safety annotations completed",
                  title: "Scaling Generative AI Safety Through Human-Led Data Labeling",
                  teaser: "205,000 safety annotations across text and video — validating content moderation pipelines and delivering defensible evidence of safety performance for audits and governance.",
                }}
              />
            </div>
          </motion.div>
