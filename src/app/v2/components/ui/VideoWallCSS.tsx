...
// ---------------------------------------------------------------------------
// Every tile renders <video> with poster fallback. Concurrent decode pressure
// is mitigated by IntersectionObserver-driven lazy play (see VideoTile below)
// + preload="none" + per-tile small file sizes — the previous "image-only" cap
// was dropped because users want the wall fully alive.
// ---------------------------------------------------------------------------
